function [fitness] = LatticeIncRestFminFitness(x, Arch, Phase, hA, latEm,...
    intMatTarget, OptParams)
...
intMat = [intPdopNorth; intPdopNom; intPdopSouth];
intErr = intMatTarget-intMat;
